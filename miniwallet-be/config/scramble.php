...
Daftar lewat `POST /api/register` atau login lewat `POST /api/login`. Keduanya
mengembalikan Sanctum token pada response body **dan** memasang token tersebut
sebagai cookie `httpOnly` untuk dipakai browser.
...
MD,
     ...
     */
    /*
     * Routes protected by `auth:sanctum` are documented as requiring a bearer
     * token, and the rest are marked public, straight from the route middleware.
     */
